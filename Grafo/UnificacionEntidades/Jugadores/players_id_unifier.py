...
def player_id_unifier():
    ...
    sofifa = pd.read_csv('./Aplicacion/Grafo/UnificacionEntidades/players_16_20_sofifa.csv')
    fbdb = pd.read_csv('./Aplicacion/Grafo/UnificacionEntidades/players_fbdb.csv', encoding='latin-1')
    ...
    definite, candidates, total = unify_entities(sofifa, fbdb, 'name_from_url', 'name', 'id', 'playerID',
                                          ...
                                          output_file='./Aplicacion/Grafo/UnificacionEntidades/jugadores_unificados.csv',
                                          output_file_candidates='./Aplicacion/Grafo/UnificacionEntidades/jugadores_candidatos.csv')
