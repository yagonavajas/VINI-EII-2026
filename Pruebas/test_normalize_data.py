...
import pandas as pd
from Aplicacion.Fuentes.kaggle.footballdatabase.kaggleFootbalDatabaseParser import procesarTemporada, procesarEquiposTemporada
from  Aplicacion.Fuentes.csv_sofifa.sofifaFilter import combine_team_files, combine_player_files
...
def test_procesarTemporada():
    ...
    games_output_path = f"./Aplicacion/Fuentes/kaggle/footballdatabase/generados/games_16_20_fbdb.csv"
    appearances_output_path = f"./Aplicacion/Fuentes/kaggle/footballdatabase/generados/appearances_16_20_fbdb.csv"
...
def test_procesarEquiposTemporada():
    ...
    teamstats_output_path = f"./Aplicacion/Fuentes/kaggle/footballdatabase/generados/teamstats_16_20_fbdb.csv"
...
def test_combine_team_files():
    ...
    output_path = root_dir / "Aplicacion" / "Fuentes" / "csv_sofifa" / output_filename
