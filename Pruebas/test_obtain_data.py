...
from Fuentes.kaggleDownloader import KaggleDownloader
from Fuentes.SoFifascraper import SoFIFAScraper
from Fuentes.wikiDataQuerys import WikidataCompetitionScraper

def test_download_dataset():
    downloader = KaggleDownloader(base_output_dir=os.path.join(root_dir, "./Pruebas/ArchivosPrueba/kaggle_test/"))
...
def test_fetch_multiple_competitions():
    scraper = WikidataCompetitionScraper(output_dir=os.path.join(root_dir, "./Pruebas/ArchivosPrueba/wikidata_test/"))
    competitions = {
