...
def unificar_paises(): 
    ...
    ruta_sofifa = BASE_DIR / "UnificacionEntidades" / "Paises" / "players_16_20.csv"
    ruta_wikidata = BASE_DIR / "UnificacionEntidades" / "Paises" / "competiciones_wikidata.csv"
    ruta_salida = BASE_DIR  / "UnificacionEntidades" / "Paises" / "paises_unificados.csv"
